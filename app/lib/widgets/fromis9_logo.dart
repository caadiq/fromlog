...
/// fromis_9 로고 (웹 Fromis9Logo SVG와 동일 path)
class Fromis9Logo extends StatelessWidget {
  final double size;
  final Color color;

  const Fromis9Logo({super.key, this.size = 18, this.color = Colors.white});
