...
- 확정일: 2026-09-23
- 상태: 2026-09-24 구현 및 dev 검증. 모바일 큐 등록 폼은 후속 작업.
...
- 선택 결과는 파일 첨부와 같은 포스터 목록에 게시물 순서로 추가한다. 목록의 삭제·좌우 이동 버튼으로 삭제·순서 변경할 수 있다.
...
- 건국대 `https://www.instagram.com/p/DdVjOk-k4bd/`의 embed에서 계정 `festival.konkuk`, 2026 일감연 본문과 이미지 4장을 확인했다. 2026-09-24 구현 검증에서 4장 전체 다운로드·변환까지 성공했다.
